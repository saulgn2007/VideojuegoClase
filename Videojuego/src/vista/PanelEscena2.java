...
public class PanelEscena2 extends JPanel implements KeyListener {
	...
	private boolean primeraBomba = true; // Para que la primera bomba no dañe al jugador
	...
	private void actualizarMovimientoEnemigo(Enemigo en) {
		...
		int m = 10; //Margen mínimo para que casi roce el bloque
		int t = 50; //El cuerpo ocupa casi toda la celda (70 - margen)
		
		// Verificamos que las 4 esquinas del hitbox estén libres para permitir el movimiento
	...
	protected void paintComponent(Graphics g) {
		...
		for (Enemigo en : enemigos) {
			if (en.vivo) g.drawImage(imgEnemigo, (int)en.x, (int)en.y, 50, 50, this);
		}
